		...
		<SafeAreaView style={{ flex: 1, backgroundColor: "black" }}>
			...
			<ScrollView>
				<View style={{ paddingHorizontal: 10, paddingVertical: 8 }}>
					...
					>
            <LikeButton likes={likes} id={route.params.id} setLikes={setLikes} isalreadyLiked={isalreadyLiked} setisalreadyDisLiked={setisalreadyDisLiked}/>
            <DisLikeButton isalreadyLiked={isalreadyLiked} setLikes={setLikes} isalreadyDisLiked={isalreadyDisLiked} setisalreadyDisLiked={setisalreadyDisLiked} setisalreadyLiked={setisalreadyLiked} id={route.params.id}/>
						<CollectButton
