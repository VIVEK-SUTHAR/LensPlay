...
const CreateProfile = ({
  ...
  const data = [
    {
      link:
        "https://gateway.ipfscdn.io/ipfs/bafkreibypw2ovrxub6mcpgw4e7gh3753emni5qtan3o3m6kdvpse3cmi44",
      handle: "iamharsh.test",
    },
    {
      link:
        "https://gateway.ipfscdn.io/ipfs/QmS2wmPQwnbpuZtqbRmEKPqNPCR39a2FTpEF7iv5G7Nixd",
      handle: "iamvivek.test",
    },
    {
      link:
        "https://gateway.ipfscdn.io/ipfs/QmZXK1cSNrj9SDZKnGaHJP9hdZvvUjUwf7uUiYqjnA5eX7",
      handle: "wagmi.test",
    },
    {
      link:
        "https://lens.infura-ipfs.io/ipfs/QmVBfhfgfhGsRVxTNURVUgceqyzjdVe11ic5rCghmePuKX",
      handle: "nader.test",
    },
    {
      link:
        ...
        <View style={[styles.container, { height: windowHeight }]}>
          <View style={{ width: "100%", alignItems: "center", flex: 1 }}>
            <View style={styles.textContainer}>
              ...
              <StyledText
                title={"Test Profile"}
                style={{ color: primary, fontSize: 38, fontWeight: "700" }}
              />
            </View>
