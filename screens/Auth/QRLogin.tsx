...
const QRLogin: FC<RootStackScreenProps<"QRLogin">> = ({ navigation }): JSX.Element => {
	return (
				...
				<View>
					...
					<View style={{ marginVertical: 10 }}>
						<Button
							...
							py={16}
							onPress={() => {
								void Linking.openURL("https://lensplay.xyz/connect");
							}}
						/>
					</View>
					<View style={styles.stepContainer}>
						...
						>
							...
							/>
							<StyledText
								title={"Click on Login with lens and Sign message through wallet"}
					...
					<View style={[styles.stepContainer]}>
						...
						<StyledText
							title={"Once connecetd and signed, scan the QR code shown on the website"}
							style={{
								color: "white",
								opacity: 0.9,
								marginLeft: 12,
