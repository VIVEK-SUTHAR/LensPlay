...
const ReportPublication = ({
  ...
  const [activeReason, setActiveReason] = useState<RESONTYPEDATA>(
    reportData[0]
  );
  const [activeSubReason, setActiveSubReason] = useState<string>(
    activeReason.subReason[0].reason
  );
                  ...
                  {activeSubReason === item.reason ? (
                    ...
                    >
                      <Icon
                        name={"done"}
                        color={
                          activeSubReason === item.reason ? "black" : "white"
                        }
                        size={18}
                      />
                    </View>
