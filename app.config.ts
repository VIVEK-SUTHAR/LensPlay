import { type AndroidManifest, type ConfigPlugin, withAndroidManifest } from "@expo/config-plugins";
 ...
 */
const addQueryToManifest = (
	androidManifest: AndroidManifestWithQuery
): AndroidManifestWithQuery => {
	const { manifest } = androidManifest;
	let packageQuery: Queries;

	xml2js.parseString(queriesXml, (_err, result: ParseResult) => {
