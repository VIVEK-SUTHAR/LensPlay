...
import { ActivityIndicator, BackHandler, Dimensions, SafeAreaView, ScrollView, View } from "react-native";
import { useAuthStore, useCommentStore, useProfile, useReactionStore, useThemeStore } from "store/Store";
