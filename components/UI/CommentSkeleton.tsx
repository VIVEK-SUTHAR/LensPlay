...
<View
    ...
    >
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{width:'100%',height:10,marginTop:12,backgroundColor:'rgba(255,255,255,0.1)'}}/>
        <View style={{width:'85%',height:10,marginTop:8,backgroundColor:'rgba(255,255,255,0.1)'}}/>
