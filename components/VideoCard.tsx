...
import { type FeedItemRoot, type Mirror, type Post } from "../types/generated";
...
const VideoCard: React.FC<VideoCardProp> = ({ width = "auto", height = 200, publication }) => {
	...
	return (
		<View style={[styles.videoCardContainer, { width }]}>
			<View style={{ height }}>
				...
				{getVideoDuration(publication.metadata)?.length > 0 && (
