...
function MentionNotifications() {
	...
	const LensNotificationTypes = [NotificationType.Mentioned];
	...
	const notifications = data?.notifications?.items as NewMentionNotification[];
	...
	const keyExtractor = (item: NewMentionNotification, index: any) => `${item?.id}-${index}`;
...
export default React.memo(MentionNotifications);
