...
import { type CreateSetDispatcherTypedDataMutation } from "../types/generated";

function createSetDispatcherTypedData(
	response: FetchResult<CreateSetDispatcherTypedDataMutation>
): any {
