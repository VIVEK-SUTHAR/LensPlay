...
import { ColorSchemeName, Image, TouchableWithoutFeedback, View } from "react-native";
			...
			screenOptions={{
				...
				headerLeft: () => (
					...
					>
						...
						>
							<SubHeading title="BETA" style={{ color: "white", fontSize: 8, fontWeight: "600" }} />
						</View>
					</View>
				),
				tabBarStyle: {
				...
				options={{
					...
					tabBarIcon: ({ focused }) => {
						return (
							...
							>
								<Avatar
									src={getIPFSLink(user?.currentProfile?.picture?.original?.url)}
									height={28}
									width={28}
								/>
							</View>
